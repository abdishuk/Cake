    ...
    return (
        <header className='sticky'>
            ...
            <Navbar   class='header' expand="lg" collapseOnSelect>
                <Container>
    <LinkContainer to='/'><Navbar.Brand ><i class="fa fa-birthday-cake" aria-hidden="true"></i>{' '}Cake Shop</Navbar.Brand></LinkContainer>
  <Navbar.Toggle aria-controls="basic-navbar-nav" />
  <Navbar.Collapse id="basic-navbar-nav">
    <Nav className="ml-auto">
    
    <LinkContainer  to="/cart"><Nav.Link className='cart'><i className='fas fa-shopping-cart' >{qty}</i>{' '}Cart</Nav.Link></LinkContainer>
      ...
      {user?
        ...
        <Nav.Link className='sign' ><b><i className='fas fa-user'></i></b>Sign In</Nav.Link>
